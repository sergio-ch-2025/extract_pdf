...
output_path = "llama_factura_prompts_train.jsonl"
    ...
    with conn.cursor() as cursor:
        ...
        with open(output_path, "w", encoding="utf-8") as fout:
            for doc in documentos:
                ...
                prompt = f"A continuación se presenta el texto extraído de una factura chilena de vehículo. Devuelve un JSON con los campos solicitados.\n\nTexto:\n{texto}"
